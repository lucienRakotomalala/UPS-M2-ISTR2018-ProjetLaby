...
for j=1 : i-2
    ...
    if ((mod(1)==1  && mod(2)==0  && (positionWallsVert{j}(positionGhost{j}(1),positionGhost{j}(2))     ==0))|| + ...
        (mod(1)==-1 && mod(2)==0  && (positionWallsVert{j}(positionPacman{j}(1),positionPacman{j}(2))   ==0))|| + ...
        (mod(1)==0  && mod(2)==1  && (positionWallsHoriz{j}(positionGhost{j}(1),positionGhost{j}(2))    ==0))|| + ...
        (mod(1)==0  && mod(2)==-1 && (positionWallsHoriz{j}(positionPacman{j}(1),positionPacman{j}(2))  ==0)))
        prise=1;
    else
        prise=0;
    end
