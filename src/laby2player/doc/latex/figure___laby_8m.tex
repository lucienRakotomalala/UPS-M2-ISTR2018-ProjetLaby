...
\begin{DoxyCompactList}\small\item\em Creation of the graphical object \char`\"{}\+Ghost\char`\"{}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Update graphical place of a player ( pacman or ghost). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Update graphical static text block about how many times ghost caught pacman. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Update graphical elements for walls around pacman, ghost or ghost sees pacman. \end{DoxyCompactList}\item 
...
Creation of the graphical object \char`\"{}\+Ghost\char`\"{}. 

The ghost is created by using the patch function and store into the handle in \textquotesingle{}ghost\textquotesingle{}. 
\begin{DoxyParams}{Parameters}
{\em handles} & structure with handles and user data (see G\+U\+I\+D\+A\+TA) \\
\hline
\end{DoxyParams}
...
Update graphical static text block about how many times ghost caught pacman. 

This function, with the output of the wrapper, show caught\+Int into the block where is write \char`\"{}\+Pacman caught \+: \char`\"{}.~\newline
...
\begin{DoxyParams}{Parameters}
{\em element\+To\+Set} & handle to the graphical object for caught status. \\
\hline
{\em caught\+Int} & How many times ghost caught pacman, from the output of the wrapper. \\
\hline
{\em stp} & Actual stop state. From the wrapper class. \\
\hline
\end{DoxyParams}
...
Update graphical place of a player ( pacman or ghost). 
...
\begin{DoxyParams}{Parameters}
{\em str\+Player} & String contain the exact name of the object to move. (\textquotesingle{}pacman\textquotesingle{} or \textquotesingle{}ghost\textquotesingle{}) \\
\hline
...
Update graphical elements for walls around pacman, ghost or ghost sees pacman. 

This function, with the output of the wrapper and a handle to the graphical element, update color of gray squares that represents walls presence around the pacman, the ghost or when the ghost sees pacman. 
\begin{DoxyParams}{Parameters}
