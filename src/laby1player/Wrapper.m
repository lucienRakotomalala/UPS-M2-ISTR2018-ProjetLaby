classdef Wrapper
    ...
    properties
        ...
        %ghostBit     % Boolean connection for the ghost.  % TODELETE
        
        modelLaby     % contain the instance of the model of labyrinth 
        commandWalls
      % TODELETE  commandGhost
        commandPacman
        stopCondition
    ...
    methods
        ...
        % TODELETE   obj.commandGhost   = ModelGhost(initGhost.ghostCommand_i);
...
%       % TODELETE     obj.out{2} = zeros(1,2); % ghost  [x y]
...
%          % TODELETE  obj.out{5} = 0 ;         % caught
%            obj.out{6} = 0 ;         % escape
%            obj.out{7} = zeros(1,4); % Walls around pacman [Up Down Left Right]
%       % TODELETE     obj.out{8} = zeros(1,4); % Walls around ghost  [Up Down Left Right]
%     % TODELETE       obj.out{9} = zeros(1,4); % Ghost sees pacman   [Up Down Left Right]
      ...
      % TODELETE          case 2
       % TODELETE               obj.ghostBit  = value ;  
        ...
        function obj = init(obj)
          ...
          % TODELETE obj.commandGhost.m(0,1);
