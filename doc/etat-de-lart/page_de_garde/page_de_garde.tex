...
\textit{\center{\Large  ``Analysis and robust control of discrete event process by non-deterministic model and set methods : application in Cartesian varying maze resolution,\break with uncertain dynamics or measures.''}\\[0.5cm]}
\end{center}
% Title :
