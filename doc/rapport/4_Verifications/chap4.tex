...
\subsubsection{Le programme s’arrête quand le pacman est sur la sortie}
...
\subsection{Déterminer l'ensemble des chemins} % Need a Fucking better title !! TODO
...
\subsection{Produit parallèle avec Matlab}
